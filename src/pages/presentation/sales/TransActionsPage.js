...
const TransActionsPage = () => {
		...
		onSubmit: (values) => {
			...
			showNotification(
				<span className='d-flex align-items-center'>
					...
					<span>Đang thêm giao dịch! Chờ duyệt từ quản lý!</span>
				</span>,
	...
	return (
		<PageWrapper title={demoPages.sales.subMenu.transactions.text}>
			<SubHeader>
				<SubHeaderLeft>
					<strong>Giao dịch vừa thêm</strong>
					<div
						className={`bg-l${
					...
					<div className='text-muted'>
						<small>
							Số tiền: <span className='text-info fw-bold'>25.000.000 VND</span>
						</small>
					</div>
				</SubHeaderLeft>
				<SubHeaderRight>
			...
			<Modal
				...
				<ModalHeader setIsOpen={setNewTransferModal}>
					<ModalTitle id='transfer-modal'>Thêm mới giao dịch</ModalTitle>
				</ModalHeader>
					...
					<div className='row w-100'>
						<div className='col-3 mx-auto shadow-3d-container'>
							<Wizard
								...
								<WizardItem id='step1' title='Thông tin đơn hàng'>
									<Card>
										<CardHeader>
											<CardLabel icon='Edit' iconColor='warning'>
												<CardTitle>Thông tin khác hàng</CardTitle>
											</CardLabel>
										</CardHeader>
