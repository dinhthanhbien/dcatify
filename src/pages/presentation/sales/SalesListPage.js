...
const SalesListPage = () => {
	...
	const filteredData = data.filter(
		(f) =>
			...
			//	Company
			((formik.values.SonVuMedia ? f.store === 'SonVuMedia' : false) ||
		...
		<PageWrapper title={demoPages.sales.subMenu.salesList.text}>
			<SubHeader>
				<SubHeaderLeft>
					...
					<span>
						<strong>Report by</strong> <span>John Doe</span>
					</span>
				</SubHeaderLeft>
				<SubHeaderRight>
					...
					{(formik.values.SonVuMedia ||
						...
						<CommonFilterTag
							title='Store'
							text={
								(formik.values.SonVuMedia ? 'SonVuMedia, ' : '') +
									...
									<div className='col-12'>
										<FormGroup>
											...
											<Select
												...
												list={[
													{ value: 'Top Item Sell', text: 'Top Item Sell' },
										...
										<FormGroup>
											...
											<ChecksGroup>
												<Checks
													...
													label='SonVuMedia'
													onChange={formik.handleChange}
													checked={formik.values.SonVuMedia}
												/>
												<Checks
													id='companyB'
													label='Company B'
